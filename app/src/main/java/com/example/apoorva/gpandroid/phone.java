...
public class phone extends AppCompatActivity implements View.OnClickListener {
    ...
    private String contactno, name_user;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mCallbacks = new PhoneAuthProvider.OnVerificationStateChangedCallbacks() {
           ...
           //     updateUI(STATE_VERIFY_FAILED);
                Toast.makeText(phone.this, "verification failed", Toast.LENGTH_LONG).show();
                // [END_EXCLUDE]
            }
            ...
            public void onCodeSent(String verificationId,
                ...
                // [START_EXCLUDE]
                // Update UI
                Toast.makeText(phone.this, "code sent", Toast.LENGTH_LONG).show();
    ...
    private void updateUI(int uiState, FirebaseUser user, PhoneAuthCredential cred) {
        switch (uiState) {
            ...
            case STATE_VERIFY_SUCCESS:
                ...
                Toast.makeText(phone.this, "verification success", Toast.LENGTH_LONG).show();
