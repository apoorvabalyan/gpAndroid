...
public class exit extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mPreferences = exit.this.getSharedPreferences("User", MODE_PRIVATE);
    ...
    public void startauthentication(){
        ...
        if(temporary!= null && !temporary.isEmpty()){
            ...
            Intent y = new Intent(exit.this, phone.class);
    ...
    public void signoutbutton(View s) {
        if (s.getId() == R.id.sign_out) {
            ...
            AlertDialog.Builder builder = new AlertDialog.Builder(exit.this);
