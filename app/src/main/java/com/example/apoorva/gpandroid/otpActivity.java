...
/**
 * Created by Jahnavi on 4/26/2018.
 */
...
public class otpActivity extends AppCompatEditText {
    ...
    public otpActivity(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }
    public otpActivity(Context context, AttributeSet attrs, int defStyleAttr) {
